...
VALUES (1, 2, 5, 'acceptée*', '2017-04-19 07:56:50', '2017-03-26 11:58:58', '2017-04-19 07:56:50'), (2, 2, 6,
  ...
  (3, 2, 6,
   ...
   NULL, '2017-03-27 16:51:20', '2017-03-27 16:51:20'), (4, 1, 8,
                                                         ...
                                                         NULL, '2017-04-03 14:47:27', '2017-04-19 01:36:10'), (5, 2, 7,
...
/*!40000 ALTER TABLE `error_messages`
  DISABLE KEYS */;
/*!40000 ALTER TABLE `error_messages`
  ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (35, '2014_10_12_000000_create_users_table', 1), (36, '2014_10_12_100000_create_password_resets_table', 1),
  ...
  (49, '2014_10_12_000000_create_users_table', 1), (50, '2014_10_12_100000_create_password_resets_table', 1),
  (51, '2017_03_21_230255_create_bugs_table', 1), (52, '2017_03_21_230301_create_comments_table', 1),
  (53, '2017_03_26_183736_create_error_messages_table', 1);
/*!40000 ALTER TABLE `migrations`
  ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `users`
  DISABLE KEYS */;
INSERT INTO `users` (id, name, email, password, admin, notifyBug, notifyComment, remember_token, created_at, updated_at)
VALUES
  (1, 'Oliver Merlin
[Team
Pluto]', 'merlin.olivier71@gmail
.com',
   '$2y$10$22xycpP/gww3eNfFB0QbBup6lpU1uQzPZSJjNWfZy1uqd31UOxH/6', 1, 1, 0,
   ...
   '2017-03-24 13:01:24'), (2, 'Julien Cordeau [Team Pluto]', 'julien-cg@hotmail.fr',
                            ...
                            1, 0,
                            'KJcL2UaGQEEdFQfGMYI5UN4MYF5UMRwZajAgMQGYYkhj3y9ifAL6mRlTK0jg',
                            '2017-03-24 13:45:40', '2017-03-24 13:46:03'),
  (3, 'Thibault Nougues  [Team Pluto]', 'thibault.nougues@hotmail.fr',
   '$2y$10$8fnhtqIq4QKSUTusiuK2iOXTkJaJXCerZWQm7epiDQFHAIbDQZSgW', 1, 1, 0,
   '6O83FnqtQkG4l8XldSzqDzYgYw9rDRjMfuupbpQ7G546eUqndJjEw0xkfQRX', '2017-03-26 16:10:13', '2017-03-26 17:24:23'),
  (4, 'Morgane', 'boisgontier.tlse3@gmail.com', '$2y$10$jbFa4/sLsMd7eQYwIRUruug8dfggq.QNMxfuw5DD/MHo905yYKwn6', 0, 1, 0,
   NULL, '2017-03-26 17:22:56', '2017-03-26 17:22:56'),
  (5, 'Quentin', 'begue.quentin@gmail.com', '$2y$10$H36ZfUXAkddGu5h/pANdiuQM19koC7oNQGtaTwBtr.h/Jq2gRGp7C', 0, 1, 0,
  ...
  (6, 'SABLAYROLLES Louis', 'louis.sablayrolles@gmail.com',
   '$2y$10$icOq36PXvruGP13wH5iq8OyVoHZusj2UJPd3nLAUbC/20TcGT4j3m', 0, 1, 0,
