...
@section('content')
    <div class = "col-sm-8 blog-main">
        ...
        <div class = "blog-post">
            ...
            <p class = "blog-post-meta">Mardi 21 Mars 2017 par <a href = "#">Julien</a></p>

            <p>Cette section vous explique pas à pas comment installer l'application sTimeTable.</p>
            <hr>
            <p>Cette application nécessite la version <a href = "#">Android Kit Kat (4.4)</a> pour fonctionner.</p>
            <h2>Heading</h2>
