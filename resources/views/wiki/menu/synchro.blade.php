...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-8 blog-main">
            <div class="blog-post">
                <h2 class="blog-post-title">Menu - Synchroniser</h2>
                ...
                <img src="{{URL::asset('images/synchro.png')}}" alt="" class="wiki-image">

            </div><!-- /.blog-post -->

            <a href="{!! route('wiki.menu.exam') !!}" class="btn btn-primary pull-left">Précédent : Vue Examens</a>
            <a href="{!! route('wiki.menu.pdf') !!}" class="btn btn-primary pull-right">Suivant : Export PDF</a>
            <div><br><br></div>
        </div><!-- /.blog-main -->
        @include('layouts.nav')
    </div>
